...
exports.verifyJWT = exports.generateTemporaryJWT = exports.generateJWT = exports.JWTAuthenticate = void 0;
var jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
var JWTAuthenticate = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    var accessToken;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, exports.generateJWT)({ _id: user._id })];
            case 1:
                accessToken = _a.sent();
...
var generateTemporaryJWT = function (payload) {
    return new Promise(function (resolve, reject) {
        return jsonwebtoken_1.default.sign(payload, process.env.JWT_SECRET, { expiresIn: "1 day" }, function (err, token) {
            if (err)
                reject(err);
            resolve(token);
        });
...
exports.generateTemporaryJWT = generateTemporaryJWT;
